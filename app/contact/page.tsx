    ...
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wide">Get In Touch</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl border-2 border-gray-100 p-8 md:p-12 shadow-sm">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-xl hover:from-emerald-600 hover:to-teal-700 transition-all shadow-lg shadow-emerald-500/30"
                >
                  Send Message
                </button>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@techvibe.eu</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+44 20 3456 7890</p>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl border-2 border-emerald-100 p-8">
              <h3 className="font-bold text-gray-900 mb-3">Need quick help?</h3>
              <p className="text-gray-600 text-sm mb-4">
                Check out our shipping information page for answers to common questions.
              </p>
              <Link
                href="/shipping"
